...
DATA_STYLE = (
    ...
    "recommendations, or citations. When an antibody isn't in the dataset, say so plainly and "
...
DATA_ONLY_INSTRUCTIONS = (
    ...
    "verdicts per application (a WB result does not carry to IF/IP/FC)."
    ...
    "link the gene page, then name the recommended alternatives — that reader has a decision to "
    "make and the data to make it exists. Frame it as a pointer, never as criticism: an "
    "antibody being untested is not a verdict on it."
)
